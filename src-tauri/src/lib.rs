...
fn get_model_registry() -> Vec<(&'static str, &'static str, &'static str, &'static str, &'static str, &'static str)> {
    vec![
        ...
        ("eu", "Multilingual Parakeet TDT 0.6B", "parakeet-tdt-0.6b-v3.f32.gguf",
         "https://huggingface.co/Singla0009/Parakeet-TDT-0.6B-Multilingual-GGUF/resolve/main/parakeet-tdt-0.6b-v3.f32.gguf",
         "25+ Languages", "~2.6 GB VRAM"),
...
async fn run_transcription(
    ...
    let decoder_type = if model_path_str.to_lowercase().contains("tdt") || model_path_str.to_lowercase().contains("transducer") { 
        "tdt" 
